...
describe('Encode', function(){
	...
	describe('Given number 1', function(){
		it('should return 3mgg', function(){
			assert.equal('3mgg', shrti.encode(1));
		})
	});
	describe('Given number 1 with appendix 10', function(){
		it('should return 3mgg', function(){
			assert.equal('3mgg', shrti.encode(1, 10));
		});
	});
});
